...
@TeleOp(name = "DeathBot Tele-Op", group = "Freight Frenzy")
public class DeathBotTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DcMotor gear = hardwareMap.dcMotor.get("Gear");

        left.setDirection(DcMotor.Direction.REVERSE);
        right.setDirection(DcMotor.Direction.FORWARD);

        gear.setDirection(DcMotor.Direction.FORWARD);
