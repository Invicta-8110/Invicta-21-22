...
@Autonomous(name="BlueRightAuton",group="Freight Frenzy")
public class BlueRightAuton extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.extender.setTargetPosition(944);
...
//    }
     public void placePreload(int barcode) {
         ...
         if (barcodeWithElement == 3) {
             ...
             robot.clawAngle.setPosition(0.38);
             sleep(1000);
             ...
             robot.clawAngle.setPosition(0.45);
             sleep(1000);
